...
import 'package:chat/src/services/typing/typing_notification_service_cotract.dart';
...
class TypingNotification implements ITypingNotification {
  ...
  Stream<TypingEvent> subscribe(User user, List<String> userIds) {
    _startReceivingTypingReceipts(user, userIds);
  ...
  _startReceivingTypingReceipts(User user, List<String> userIds) {
    _changefeed = _r
        .table('typing_events')
        .filter((event) {
          return event('to')
